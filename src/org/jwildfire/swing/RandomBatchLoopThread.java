...
public class RandomBatchLoopThread extends Thread {
  ...
  public RandomBatchLoopThread(TinaController tinaController, int pCount, RandomFlameGenerator randGen, RandomSymmetryGenerator randSymmGen, RandomGradientGenerator randGradientGen, RandomWeightingFieldGenerator randomWeightingFieldGen, RandomBatchQuality pQuality) {
    this.pCount = pCount;
